 ...
 * 课程列表的实现的Activity
 */
public class CourseComplexListActivity extends ComplexListActivity<ComplexModelSet.M_courCla_onliStudReco> {
    ...
    @Override
    protected void bindViewValue(ListViewCommonsAdapter.ViewHolder holder, ComplexModelSet.M_courCla_onliStudReco obj) {

        holder.setText(R.id.title, obj.classification.courseName);
    ...
    @Override
    protected void itemClick(AdapterView<?> parent, View view, int position, long id, ComplexModelSet.M_courCla_onliStudReco item) {
        /**
         * 进入详情界面
         */
